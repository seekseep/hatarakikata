...
export function buildPrompt(
  ...
  return [
    ...
    "{",
    "  actions: Array<",
    "    | { type: 'create', payload: { name: string, type: 'living' | 'working' | 'feeling', startDate: string, endDate: string, tagNames: string[], strength: number, description: string | null } }",
    "    | { type: 'update', payload: { id: string, ...変更フィールドのみ（name, type, startDate, endDate, tagNames, strength, description）} }",
    "  >,",
